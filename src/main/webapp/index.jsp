          ...
          <div class="column is-half">
            ...
            <div>
              <table border="1" style="align-items: center">
                <tr>
                  <%
                  //SE INICIA EL ARRAY
                  char arreglo[] = {'A', 'L', 'U', 'N', 'A', 'E', 'S', 'E', 'A', 'N', 'U', 'L', 'A'};



                  //CILOS Y POSICION DEL ARREGLO CON SU IMPRESION
                  for (int i = 0; i < arreglo.length; i++) {
                  %>

                  <td style="text-align: center; width: 15px;background-color:orange"><%= arreglo[i] %>
                  </td>
                  <%
                  }
                  %>
            ...
            <p>
              ...
              <script>
                ...
                //VALIDACION Y FUNCION DEL POLINDROMO
                function esPalindromo(frase) {
                  return frase === frase.split("").reverse().join("");
                }

                // arreglo en un String
